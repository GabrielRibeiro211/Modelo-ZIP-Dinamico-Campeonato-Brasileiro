...
model {
//hyper priors
mu_att ~ normal(-2.89753e-05, 0.0001089919); //based on the 2021 championship posteriors
tau_att ~ gamma(0.1,0.1);
mu_def ~ normal(3.002014e-05, 0.0001017105); //based on the 2021 championship posteriors
tau_def ~ gamma(0.1,0.1);

//priors
att ~ normal(mu_att, tau_att); 
def ~ normal(mu_def, tau_def);
home ~ normal(-5.053408e-05, 0.000128254);
